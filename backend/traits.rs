...
//!   [`crate::gen2::session_rt::truncate`]. Session-scoped because chat templates
...
use crate::gen2::kv::{KvLoadReport, KvLoadSpec, KvSaveSpec, KvSnapshot as KvSnapshotBlob};
...
/// [`crate::gen2::backend::llama`] for reference impl).
